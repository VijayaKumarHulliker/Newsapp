                      ...
                      child: Padding(
                        ...
                        child: Container( 
                          decoration: BoxDecoration( 
                            color:categoryName == categoriesList[index]?Colors.blue:Colors.grey[400],
                          ...
                          child: Padding(
                            ...
                            child: Center(
                              ...
                              child: Text(categoriesList[index].toString(),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)),
                          ),
                        ),
                      ),
                    );
